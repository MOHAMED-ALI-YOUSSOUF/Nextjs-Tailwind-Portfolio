...
const ProjectCard = () => {
  return (
    ...
    {projects.map((project, index) => (
      <motion.div 
      key={index}
      className="border bg-[#1b1b1b] border-white/20 flex flex-col md-flex-row text-white rounded-3xl sticky top-28 justify-between items-start mb-16 sm:w-[300p] h-[600px] 
     w-[1100p] "
