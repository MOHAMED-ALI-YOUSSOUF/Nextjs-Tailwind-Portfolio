...
const ProjectCard = () => {
  return (
    ...
    {projects.map((project, index) => (
      <motion.div 
      key={index}
      className="borde bg-light dark:bg-dark border-white/20 flex flex-col md-flex-row text-white rounded-3xl sticky top-28 justify-between items-start mb-16 w-full h-[600px] 
      "
